...
// Auto-generated page for: No real-time funder-deadline change tracker (analyze-deadlin

export default function GapNoRealTimeFunderDeadlineChange() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-real-time-funder-deadline-change', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No real-time funder-deadline change tracker (analyze-deadlin</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No real-time funder-deadline change tracker (analyze-deadlines is on-demand only)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No real-time funder-deadline change tracker (analyze-deadlin'}
        </button>
      </form>
