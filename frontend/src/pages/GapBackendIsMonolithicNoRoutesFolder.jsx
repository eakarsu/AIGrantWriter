...
// Auto-generated page for: Backend is monolithic (no routes/ folder) — refactor needed 

export default function GapBackendIsMonolithicNoRoutesFolder() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-backend-is-monolithic-no-routes-folder', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Backend is monolithic (no routes/ folder) — refactor needed </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Backend is monolithic (no routes/ folder) — refactor needed for testability</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Backend is monolithic (no routes/ folder) — refactor needed '}
        </button>
      </form>
