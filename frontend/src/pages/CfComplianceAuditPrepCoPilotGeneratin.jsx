...
// Auto-generated page for: Compliance + audit-prep co-pilot generating quarterly/annual

export default function CfComplianceAuditPrepCoPilotGeneratin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-compliance-audit-prep-co-pilot-generatin', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Compliance + audit-prep co-pilot generating quarterly/annual</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Compliance + audit-prep co-pilot generating quarterly/annual reporting from grant activity.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Compliance + audit-prep co-pilot generating quarterly/annual'}
        </button>
      </form>
