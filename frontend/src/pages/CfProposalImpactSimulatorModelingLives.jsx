...
// Auto-generated page for: Proposal impact simulator modeling lives-affected and cost-p

export default function CfProposalImpactSimulatorModelingLives() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-proposal-impact-simulator-modeling-lives', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Proposal impact simulator modeling lives-affected and cost-p</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Proposal impact simulator modeling lives-affected and cost-per-beneficiary against funder priorities.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Proposal impact simulator modeling lives-affected and cost-p'}
        </button>
      </form>
