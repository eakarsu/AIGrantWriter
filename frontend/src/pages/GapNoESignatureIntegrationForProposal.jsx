...
// Auto-generated page for: No e-signature integration for proposal submissions

export default function GapNoESignatureIntegrationForProposal() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-e-signature-integration-for-proposal', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No e-signature integration for proposal submissions</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No e-signature integration for proposal submissions</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No e-signature integration for proposal submissions'}
        </button>
      </form>
