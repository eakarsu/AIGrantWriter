...
// Auto-generated page for: Agentic funder discovery scanning foundation directories, fe

export default function CfAgenticFunderDiscoveryScanningFounda() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-agentic-funder-discovery-scanning-founda', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Agentic funder discovery scanning foundation directories, fe</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Agentic funder discovery scanning foundation directories, federal RFPs, and corporate giving programs.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Agentic funder discovery scanning foundation directories, fe'}
        </button>
      </form>
