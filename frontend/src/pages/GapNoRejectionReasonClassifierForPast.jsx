...
// Auto-generated page for: No rejection-reason classifier for past unsuccessful proposa

export default function GapNoRejectionReasonClassifierForPast() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-rejection-reason-classifier-for-past', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No rejection-reason classifier for past unsuccessful proposa</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No rejection-reason classifier for past unsuccessful proposals</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No rejection-reason classifier for past unsuccessful proposa'}
        </button>
      </form>
